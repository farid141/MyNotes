...
## Uneffective Way (Emit) Prop-drilling

Beberapa perilaku `emit`:

- TIDAK bubbling seperti DOM event
- hanya naik `1 level` parent component
...
## Effective Way (Provide-Inject) Non-Prop Drilling

Merupakan fitur bawaan, jadi mirip seperti `context` di react.
