...
| `watch`                   | `watchEffect`         |
| ------------------------- | --------------------- |
| dependency explicit       | dependency otomatis   |
| bisa akses old/new value  | tidak                 |
| lazy (jalan saat berubah) | langsung jalan sekali |
| lebih presisi             | lebih otomatis        |

## Sintaks

watch menerima 3 parameter.
