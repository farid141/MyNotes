...
Dapat sesuai dengan name variabel yang dikirim, tetapi konvensionalnya:
...
- Tetapi tidak berlaku sebaliknya, untuk `child ke parent` kita harus menggunakan `emit`, walaupun bisa dengan cara seperti react yang pass `function props`.
