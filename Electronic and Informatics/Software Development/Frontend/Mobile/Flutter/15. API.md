...
Ketika menggunakan `context` pada fungsi async, biasanya wajib melakukan pengecekan karena bisa saja sudah berpindah halaman:

1. Fungsi async dipanggil dan masih proses menunggu respon
2. User melakukan navigasi ke halaman lain (padahal async masih berjalan)
3. Dalam hal ini ketika fungsi async meneruskan stepnya, referensi context hilang.
