...
### Pembuatan Service di Flutter

Dari flutter, kita mengakses methodchannel java sesuai dengan nama `method` dan parameter yang diberikan.
...
### Definisi `MethodChannel` di java
